...
namespace SaltReviews\Providers;

use Illuminate\Support\ServiceProvider;

class SaltReviewsServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/salt-laravel-reviews.php' => config_path('salt-laravel-reviews.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-reviews');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-reviews');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-laravel-reviews'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-laravel-reviews');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-laravel-reviews'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltReviews\Console\Commands\SaltReviewsCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-laravel-reviews'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-laravel-reviews.php', 'salt-laravel-reviews'
        // );
    }
}
